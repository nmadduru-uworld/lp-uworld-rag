...
# The QueryCase set lives in eval_cases.py (domain fixtures); this is the generic runner.
...
# repo has onboarded. The OrchestratorCase set lives in eval_cases.py; this is the runner.
